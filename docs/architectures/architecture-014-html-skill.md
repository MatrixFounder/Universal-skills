...
> **Relocation note (2026-06-28):** this document was the entire contents of
> `docs/ARCHITECTURE.md` until that file was converted into a system-wide
> **index** (see [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md) → the chunk
> catalog). It is preserved here verbatim as the per-skill architecture chunk
> for `html` (TASK 022–027). Indexed as `architecture-014`.
