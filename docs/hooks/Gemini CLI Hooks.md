...
- **[Writing hooks guide](writing-hooks.md)**: A tutorial on creating
  your first hook with comprehensive examples.
- **[Best practices](best-practices.md)**: Guidelines on security,
  performance, and debugging.
- **[Hooks reference](reference.md)**: The definitive technical
