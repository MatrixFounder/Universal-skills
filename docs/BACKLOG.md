...
- [WI-030 — TASK 030 adversarial carry-over](backlog/wi-030-adversarial-carryover.md) — 36 findings raised by the review cycles but never verified; tracked so "3 cycles ran" is not read as "everything was examined".
