...
- **PDF-EXTRACT-DOGFOOD-CYCLE2-RESIDUALS** [что нашёл второй цикл догфуда на 20 незнакомых документах и что из этого НЕ починено](issues/pdf-extract-dogfood-cycle2-residuals.md) — severity `SEV-2`, status `open`, opened 2026-09-01
