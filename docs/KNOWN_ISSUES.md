...
- **FILE-TEXT-CODEC-LOCALE-CLASS** [`Path.read_text()` / `open(path, "w")` читают и пишут файлы кодеком локали, а не файла](issues/file-text-codec-locale-class.md) — severity `SEV-2`, status `fixed`, opened 2026-09-02, resolved 2026-09-02
