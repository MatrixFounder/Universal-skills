...
6.  Uses specific details over vague claims
7.  Maintains appropriate tone for context
8.  Uses simple constructions (is/are/has) where appropriate
...
Always answer in language of the input text.