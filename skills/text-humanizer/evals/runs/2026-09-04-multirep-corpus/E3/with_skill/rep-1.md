...
What annoys me is that the agent had been failing on and off for a week and nobody filed anything, because "it passes on retry" is the kind of sentence that ends an investigation instead of starting one.
