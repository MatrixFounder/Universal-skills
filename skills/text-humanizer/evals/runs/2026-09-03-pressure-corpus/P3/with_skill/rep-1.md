...
Everything that changes when you move off 4.1 is listed below.
...
This moves the platform toward zero-touch operations, which the roadmap has promised
since the Helsinki milestone.
