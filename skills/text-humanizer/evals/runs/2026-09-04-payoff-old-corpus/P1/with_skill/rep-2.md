...
Rotterdam moved to the new picking system on 4 February. It went badly for three days. All 62 handheld scanners dropped their session roughly every 90 seconds whenever a forklift passed the mezzanine. Nobody caught it in testing, because nobody tested with forklifts moving. We shifted the access point six metres and the scan error rate fell from 11% to 0.4%. Firmware update lands in April.
