...
## Keywords to Avoid (The "Marketing in Docs" List)
...
## Preferred Vocabulary (The "Instructional" List)
...
## Rules of Engagement
1.  **No "Title: Description" Lists**: Do not format lists as "**Speed:** The system is fast." Use a table or separate headers.
