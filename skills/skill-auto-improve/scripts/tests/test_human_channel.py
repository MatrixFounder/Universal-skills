...
Measured before the fix: `auto_improve.py --help` returned rc 1 and 0 bytes where UTF-8 returned 2302.
...
class TestTheRealCommands(unittest.TestCase):
    ...
    COMMANDS = {
        "auto_improve.py --help": [
            "skills/skill-auto-improve/scripts/auto_improve.py", "--help"],
    }
