...
| HTML → PDF via headless Chrome (pdf-11; install with `bash install.sh --with-chrome`) | `python3 scripts/html2pdf.py page.webarchive out.pdf --engine chrome` |
| Chrome engine + reader-mode (extract article, render in browser engine) | `python3 scripts/html2pdf.py page.webarchive out.pdf --engine chrome --reader-mode` |
